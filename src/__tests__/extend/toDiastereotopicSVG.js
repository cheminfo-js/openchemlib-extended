...
describe('toDiastereotopicSVG on propane and 2-chlorobutane', function () {
    ...
    it('check that is contains the diastereotopicID heavy', function () {
        ...
        svgHeavy.indexOf('gGPDALfHRYjjThU@_iDBIU@,gGPDALfHRYjjThQ@_iDBIU@').should.be.above(100);
    });
});
